...
- Write commit messages following Conventional Commits: keep the English prefix such as `feat:`, `fix:`, `docs:`, or `chore:`, and write the description in Vietnamese. Keep it concise, do not capitalize the first letter, and do not add a period at the end.
