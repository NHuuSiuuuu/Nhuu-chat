...
Before deploying the Messenger release to an existing Atlas database, take a backup and run both index migrations against production during a maintenance window. They do not run automatically at API startup:
