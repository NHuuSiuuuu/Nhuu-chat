...
export function SettingsPage({ onLogoClick, onNavigate }: SettingsPageProps) {
  ...
  const [tags, setTags] = useState(["Câu hỏi", "Hết hàng", "Kiểm hàng", "Mua hàng", "Đã gửi", "Trả hàng"]);
