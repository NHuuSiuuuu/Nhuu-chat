...
export function FacebookPublishingPage({ onBack, onLogoClick, onNavigate, user, onLogout, onProfile, client = defaultClient, initialConnection = null, initialPosts = [], initialMessage = "", initialMode = "now", initialScheduledAt = "", initialImageUrl = null, initialLoading = true }: FacebookPublishingPageProps) {
  ...
  return <main className="min-h-screen bg-gray-50 text-gray-800" aria-labelledby="facebook-publishing-title"><DashboardTopbar onLogoClick={onLogoClick} onNavigate={onNavigate} user={user} onLogout={onLogout} onProfile={onProfile} /><div className="px-4 py-6 sm:px-6 lg:px-8"><div className="mx-auto flex max-w-7xl items-start gap-6 max-[900px]:flex-col"><aside className="h-fit w-full shrink-0 rounded-2xl bg-white p-3 shadow-sm lg:sticky lg:top-6 lg:w-64" aria-label="Menu đăng bài Facebook"><div className="px-3 pb-3">
