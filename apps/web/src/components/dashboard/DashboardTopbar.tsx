...
export function DashboardTopbar() {
  return <header className="flex min-h-16 items-center bg-[#4e5d9a] px-7 text-white max-[700px]:flex-wrap max-[700px]:items-start max-[700px]:gap-[14px] max-[700px]:p-[14px]">
