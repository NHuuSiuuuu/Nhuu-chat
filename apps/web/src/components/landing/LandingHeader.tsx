...
function Brand({ href }: { href: string }) {
  return <a href={href} className="flex items-center text-slate-950" aria-label="NhuuChat - về đầu trang"><img className="h-8 w-[128px] object-contain" src="/nhuu-logo-landing.svg" alt="NhuuChat" /></a>;
}
