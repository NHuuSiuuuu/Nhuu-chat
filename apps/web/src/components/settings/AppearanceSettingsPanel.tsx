    ...
    <div className="mt-6 grid gap-6 xl:grid-cols-[minmax(0,1fr)_minmax(280px,.8fr)]">
      ...
      <section aria-label="Xem trước giao diện" className="self-start rounded-xl border border-gray-200 bg-[var(--surface-color)] p-4 shadow-sm">
        ...
        <div className="mt-3 overflow-hidden rounded-lg border border-gray-200 bg-white">
          <div className="conversation-item flex min-h-[88px] items-center border-b border-gray-100"><button className="flex w-full items-center gap-3 px-3 py-3.5 text-left" type="button"><span className="grid size-9 place-items-center rounded-full bg-[var(--accent-soft)] text-sm font-semibold text-[var(--accent-color)]">A</span><span><strong className="block text-sm text-gray-900">An Nguyễn</strong><span className="text-xs text-gray-500">Hội thoại gần đây</span></span></button></div>
